...
public class Caculator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(29, 29, 29)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtFirstnumber, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtSecondNumber, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double kq;
        if(check()==true){
            numb1 = Double.parseDouble(txtFirstnumber.getText().trim());
            numb2 = Double.parseDouble(txtSecondNumber.getText().trim());
            kq = numb1+numb2;
    ...
    public boolean check() {
        if (txtFirstnumber.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Mời nhập số đầu tiên");
            txtFirstnumber.setBackground(Color.red);
            txtFirstnumber.requestFocus();
            return false;
        }
        else if (txtSecondNumber.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Mời nhập số thứ hai");
            txtSecondNumber.setBackground(Color.red);
